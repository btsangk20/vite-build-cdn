...
function lr() {
  if (Oe) return F;
  Oe = 1;
  var E = we, b = Symbol.for("react.element"), U = Symbol.for("react.fragment"), O = Object.prototype.hasOwnProperty, I = E.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, W = { key: !0, ref: !0, __self: !0, __source: !0 };
  function j(R, c, S) {
    var p, h = {}, _ = null, $ = null;
    S !== void 0 && (_ = "" + S), c.key !== void 0 && (_ = "" + c.key), c.ref !== void 0 && ($ = c.ref);
    for (p in c) O.call(c, p) && !W.hasOwnProperty(p) && (h[p] = c[p]);
    if (R && R.defaultProps) for (p in c = R.defaultProps, c) h[p] === void 0 && (h[p] = c[p]);
    return { $$typeof: b, type: R, key: _, ref: $, props: h, _owner: I.current };
  }
...
function cr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    var E = we, b = Symbol.for("react.element"), U = Symbol.for("react.portal"), O = Symbol.for("react.fragment"), I = Symbol.for("react.strict_mode"), W = Symbol.for("react.profiler"), j = Symbol.for("react.provider"), R = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), S = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), _ = Symbol.for("react.lazy"), $ = Symbol.for("react.offscreen"), Q = Symbol.iterator, Ce = "@@iterator";
    function Pe(e) {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === O || e === W || Ae || e === I || e === S || e === p || Fe || e === $ || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === _ || e.$$typeof === h || e.$$typeof === j || e.$$typeof === R || e.$$typeof === c || // This needs to include all possible module reference object
    ...
    var m = Object.assign, x = 0, te, ne, ae, oe, ie, ue, se;
    function fe() {
    }
...
` + a[s].replace(" at new ", " at ");
    ...
    var k = Object.prototype.hasOwnProperty, ce = {}, ve = w.ReactDebugCurrentFrame;
    function M(e) {
      if (e) {
    ...
    function Te(e, r, t, n, i, u) {
      {
        ...
        if (!o) {
          ...
          v ? a += v : a += he();
          var s;
          e === null ? s = "null" : q(e) ? s = "array" : e !== void 0 && e.$$typeof === b ? (s = "<" + (y(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, l("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var f = Qe(e, r, t, i, u);
        if (f == null)
          return f;
...
var vr = Z.exports;
const yr = () => /* @__PURE__ */ vr.jsx("div", { children: "Button" });
export {
  yr as Button,
  gr as subtract,
  pr as sum
